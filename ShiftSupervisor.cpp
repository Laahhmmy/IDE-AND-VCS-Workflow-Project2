...
ShiftSupervisor::ShiftSupervisor(string n, int numb, string date,
...
double ShiftSupervisor::getProductionBonus() const {
...
void ShiftSupervisor::setProductionBonus(double b) {
    productionBonus = b;
}
